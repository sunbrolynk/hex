...
run bash -c "set -o pipefail; uv run coverage report --include='*/hex/secrets/*,*/hex/setup/*,*/hex/audit/*,*/hex/oidc/*,*/hex/breakglass/*,*/hex/authentik/admin_client.py,*/hex/authentik/errors.py,*/hex/authentik/runtime_config.py,*/hex/authentik/wiring_client.py,*/hex/authentik/orchestrator.py,*/hex/database/setup_manager.py,*/hex/database/audit_manager.py,*/hex/database/authentik_integration_manager.py,*/hex/database/user_manager.py,*/hex/database/session_manager.py,*/hex/database/login_state_manager.py,*/hex/api/auth_routes/*,*/hex/api/breakglass_routes/*,*/hex/api/guards.py' --fail-under=95 | grep -E 'hex/secrets|hex/setup|hex/audit|hex/oidc|hex/breakglass|hex/authentik|setup_manager|audit_manager|authentik_integration_manager|user_manager|session_manager|login_state_manager|auth_routes|breakglass_routes|guards'"
